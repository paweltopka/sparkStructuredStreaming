  ...
  def main(args: Array[String]): Unit = {
    ...
    new Thread(new Runnable() {
      override def run(): Unit = {
        ...
        Thread.sleep(10000)
        memoryStream.addData(new TimestampAndWord(new Timestamp(startTime+14000),"dog"))
        memoryStream.addData(new TimestampAndWord(new Timestamp(startTime+9000),"cat"))
        Thread.sleep(10000)
        ...
        memoryStream.addData(new TimestampAndWord(new Timestamp(startTime+10000),"owl"))
